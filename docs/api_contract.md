...
- **Dimensions**: `project`, `discom`, `zone`, `circle`, `division`, `subdivision`, `substation`, `feeder`, `dtr`, `new_meter_type`, `meter_category` (e.g. `Consumer`, `Feeder`, `DTR`)
...
- **Parameters**: `project`, `meter_category`, `period` (daily/weekly/monthly), `start_date`, `end_date`, plus all geographical dimensions (`discom`, `zone`, etc.)
- **Summary Response**:
```json
{
...
- **Parameters**: `project`, `meter_category`, `technician`, `period`, `start_date`, `end_date`, plus all geographical dimensions (`discom`, `zone`, etc.)
- **Response Row**:
```json
{
  "technician": "John Doe",
...
- **Parameters**: `project`, `meter_category`, `period_value` (YYYY-MM), `start_date`, `end_date`, plus all geographical dimensions (`discom`, `zone`, etc.)
- **Summary Response**:
```json
{
...
- **Parameters**: `project`, `meter_category`, `start_date`, `end_date`, plus all geographical dimensions (`discom`, `zone`, etc.)
...
### KPI 6: Stock Ageing
- **Detail Endpoint**: `GET /api/mi/stock-ageing`
- **Description**: Returns unutilized stock ageing details (meters not yet installed).
- **Parameters**: 
...
- **Params**: `project`, `meter_category`, `period`, plus all geographical dimensions
- **Response Row**:
```json
{
  "project": "agra",
