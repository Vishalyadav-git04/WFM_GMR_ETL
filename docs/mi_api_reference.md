...
| `meter_category`| String | `Consumer`, `Feeder`, `DTR`, `DTR/Feeder` |
...
- **Detail Endpoint**: `GET /api/mi/stock-ageing?limit=100`
- **Description**: Returns unutilized stock ageing details (meters not yet installed). This is a snapshot KPI and does not support dimension or date filtering.
- **Test URL**:
